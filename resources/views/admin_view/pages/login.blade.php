...
<head>
    ...
    <title>Log In | Khan bake light</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="khan bakelite" name="description" />
                    ...
                    <div class="card-header pt-4 text-center">
                        <div class="auth-brand mb-0">
                            <a href="index.html" class="logo-dark">
                                <span><img src="landing_assets/images/khan.png" alt="dark logo" height="50"></span>
                            </a>
                            <a href="index.html" class="logo-light">
                                <span><img src="landing_assets/images/khan.png" alt="logo" height="30"></span>
                            </a>
                        </div>
                    </div>
                        ...
                        <form action="#">
                          @csrf
                            ...
                            <div class="mb-3 mb-0 text-center">
                                <button class="btn btn-primary" type="submit" id="submitLoginForm"> Log In </button>
                            </div>
