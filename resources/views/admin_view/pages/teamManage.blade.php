...
@section('container')
                                                    ...
                                                    <div class="card-body">
                                                        <div class="hstack gap-2 flex-wrap">
                                                            <button type="button" class="btn btn-primary"
                                                                    ...
                                                                    data-bs-whatever="@getbootstrap">Team Members Profile Upload
                                                            </button>
                                                        </div>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="button" class="btn btn-primary"
                                                                                id="submitMembersProfileForm">Save
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            </div>
    ...
    <script src="admin_assets/js/TeamMemberProfileManage.js"></script>
@endsection
